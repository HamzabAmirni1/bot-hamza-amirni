...
const RAW_CATEGORIES = {
    ...
    tools: [
        'tomp3', 'qrcode', 'tts', 'say', 'hazf-sawt', 'ping', 'lyrics', 'simage'
    ],
    fun: [
...
const arCmds = {
    ...
    // Tools
    tomp3: 'صوت', qrcode: 'كيو-آر', tts: 'نطق', say: 'قول', 'hazf-sawt': 'حذف-صوت', ping: 'بينغ', lyrics: 'كلمات', simage: 'صورة',
    // Fun

...
const RAW_CATEGORIES = {
    ...
    download: ['pinterest', 'pinterestdl', 'ytmp4v3', 'facebook', 'instagram', 'tiktok', 'youtube', 'mediafire', 'github', 'gitrepo', 'play', 'play2', 'song', 'song2', 'video', 'ytplay', 'yts', 'yts2', 'apk', 'apk2', 'apk3', 'capcut', 'f-droid', 'likee', 'live', 'qdl', 'reddit', 'snapchat', 'spotify', 'tahmil-app', 'twitter', 'ytdl', 'ytmp4', 'ytmp4v2'],
    ...
    general: ['alive', 'ping', 'owner', 'script', 'setlang', 'system', 'help', 'allmenu', 'menuu'],

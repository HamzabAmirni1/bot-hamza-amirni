...
const BANNED_KEYWORDS = [
    ...
    'روتين اليومي', 'روتين يومي', 'روتيني اليومي', 'روتيني يومي',
    'الموقع الأزرق', 'الموقع الازرق', 'موقع الأزرق', 'موقع الازرق',
    'الفيلم الأزرق', 'الفيلم الازرق', 'فيلم أزرق', 'فيلم ازرق',
    'موقع إباحي', 'موقع اباحي', 'مواقع إباحية', 'مواقع اباحية',
    'الموقع الإباحي', 'الموقع الاباحي', 'المواقع الإباحية', 'المواقع الاباحية',
    'قصص جنسية', 'قصص إباحية', 'قصص اباحية', 'روايات جنسية', 'روايات إباحية', 'روايات اباحية',
    'أفلام إباحية', 'أفلام اباحية', 'أفلام الكبار', 'افلام الكبار',
    'routini lyawmi', 'routini yawmi', 'rotini yawmi', 'rotini lyawmi',
    'site bleu', 'film bleu', 'film blue',
    'lmo9i3 l2azra9', 'lmo9i3 l2azraq', 'lmo9i3 l2azrak', 'mo9i3 l2azraq', 'mo9i3 l2azra9',
    'site 27', 'site x',

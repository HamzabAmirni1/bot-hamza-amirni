...
module.exports = async (sock, chatId, msg, args, commands, userLang) => {
    try {
        ...
        const arDescs = {
            ...
            'news': 'آخر الأخبار العالمية والمحلية', 'akhbar': 'أخبار المغرب والعالم',
            'football': 'نتائج ومواعيد مباريات اليوم', 'kora': 'كورة مباشر',
            ...
            'uptodown': 'تحميل برابط Uptodown المباشر',
            // Tools
